...
export const getAustraliaHolidaysForYear = (year: number): Holiday[] => {
  ...
  if (year === 2026) {
    ...
    holidays.push({ id: `au-tas-hobart-regatta-2026`, name: "Royal Hobart Regatta", date: new Date(2026, 1, 9), type: HolidayType.Regional, stateIds: [StateId.TAS], description: "Southern Tasmania public holiday for the Royal Hobart Regatta, the largest aquatic carnival in the Southern Hemisphere." });
